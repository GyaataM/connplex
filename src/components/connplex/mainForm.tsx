        ...
        <Form className="w-full md:w-[300px]">
          ...
          >
            ...
            <div className="w-full flex justify-center">
              <Button
                type="submit"
                className={`group cursor-pointer mt-5 px-10 py-[6.5px] h-[35px] rounded-full font-semibold text-xs bg-[#D3B15F] mb-2 flex items-center justify-center text-[12px] ${
                  varient === "dark" ? "w-full" : ""
                }`}
              >
                Get Started
